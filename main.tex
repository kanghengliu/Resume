...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Advised and mentored students in Neural Network and Deep Learning curriculum.}
    ...
    % health advices and services of early warning for sub-health.}{}
          ...
          \resumeItemListStart
            \resumeItem{Gathered data (information collection, text semantic analysis and classification), cleaned and pipelined to application backend database.}
      ...
      \resumeProjectHeading
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{macOS Installation on Non-supported Hardware} $|$ \emph{C++, bash, ACPI, AppleScript}}{Sept 2019 -- Dec 2022}
          \resumeItemListStart
            \resumeItem{Installed macOS on spoofed non-supported HP laptop, written Kernel patches for motherboard ACPI table. }
            \resumeItem{Contributed to VoodooSMBus/VoodooRMI driver repo on github for better touchpad functionality. }
            \resumeItem{Written ACPI patches for optimizing hardware performance, extending battery life by 40\% while maintaining same CPU performance.}
            % \resumeItem{Implemented object-oriented programming practices such as inheritance to create different account types and databases.}
          \resumeItemListEnd 
    \resumeSubHeadingListEnd
\vspace{-15pt}
