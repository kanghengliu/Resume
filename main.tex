...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Lua, R, bash, HTML/CSS, JS, TS, C, SQL, C++, ACPI Source Language, AppleScript} \\
     \textbf{Developer Tools}{: Neovim, VS Code, Huawei Cloud Platform, AWS, Azure, GCP, Xcode} \\
     \textbf{Technologies/Frameworks}{: Linux, Tensorflow, Pytorch, Langchain, NextJS, ReactJS, GitHub, Gitee, Quarto, \LaTeX, macOS Kernel Extension} \\
    }}
 \end{itemize}
 \vspace{-16pt}
